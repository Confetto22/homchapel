  ...
  return (
    <>
      {loading ? (
        ...
        <section className="bg-[url('https://res.cloudinary.com/dv9aqxptd/image/upload/v1729595283/homchapel/rb_119211_excoa6.png')]  bg-cover bg-center bg-no-repeat ease-in-out duration-300 dark:bg-[url('https://res.cloudinary.com/dv9aqxptd/image/upload/v1729597210/homchapel/hand-drawn-minimalist-background_znfifr.png')]">
              ...
              >
                <div className=" w-[95%] flex flex-col gap-1 items-start md:flex-row md:items-center md:justify-between">
                  <p className="text-gray-100 text-left  font-semibold text-sm md:text-base md:w-[80%]  ">
                    New to HOM Chapel? Find out all key information about us
                    here!
                  </p>
                  <Link
                    to={"/new-here"}
